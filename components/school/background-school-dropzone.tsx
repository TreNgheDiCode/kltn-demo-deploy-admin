...
const variants = {
  ...
  image: "border-0 size-full relative",
  active: "border-2",
  disabled:
  ...
  (
    ...
    const {
      ...
      onDrop: (acceptedFiles) => {
        ...
        if (file) {
          void onSelectedFile?.({ file, progress: "PENDING" });
        }
      },
      ...dropzoneOptions,
    });
    ...
    return (
      <div className="relative">
        ...
        >
          ...
          {imageUrl ? (
            ...
            <div className="flex flex-col items-center justify-center text-xs text-gray-400">
              ...
              <div className="text-gray-400">
                Kéo thả hình ảnh vào đây hoặc chọn hình.
              </div>
            </div>
          )}
          ...
          {imageUrl && !disabled && (
            <div
              className="group absolute right-2 top-2 z-10 -translate-y-1/4 translate-x-1/4 transform"
              onClick={(e) => {
                e.stopPropagation();
                void onSelectedFile?.(undefined);
              }}
            >
