...
export function PickerExample({
  ...
  return (
    <div
      className="w-full h-full preview flex justify-center p-10 items-center rounded !bg-cover !bg-center transition-all"
      style={{ background }}
    >
      <GradientPicker
        id={id}
...
const GradientButton = ({
  ...
  return (
    <div
      className="p-0.5 rounded-md relative !bg-cover !bg-center transition-all w-full"
      style={{ background }}
    >
